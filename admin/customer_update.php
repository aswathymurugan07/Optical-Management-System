...
mysqli_query($con,"UPDATE customer set customerid='" . $_POST['customerid'] . "', customer_name='" . $_POST['customer_name'] . "', c_mail='" . $_POST['c_mail'] . "', c_address='" . $_POST['c_address'] . "', c_phoneno='" . $_POST['c_phoneno'] . "',c_password='" . $_POST['c_password'] . "' WHERE customerid='" . $_POST['customerid'] . "'");
$message = "Record Modified Successfully";
}

$result = mysqli_query($con, "SELECT * FROM customer where customerid='" . $_GET['id'] . "'");
...
<div style="margin-left: 500px;top:6pc;position: absolute;">
            ...
            <h1 style="color: rgb(79, 4, 44);font-size: 25px;font-family: cursive;margin-left: 40px;">Customer Updates</h1><br>
