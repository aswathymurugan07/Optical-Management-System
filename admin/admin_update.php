...
mysqli_query($con,"UPDATE admin set adminid='" . $_POST['adminid'] . "', admin_name='" . $_POST['admin_name'] . "', Admin_password='" . $_POST['Admin_password'] . "'  WHERE adminid='" . $_POST['adminid'] . "'");
$message = "Record Modified Successfully";
}

$result = mysqli_query($con, "SELECT * FROM admin where adminid='" . $_GET['id'] . "'");
