...
mysqli_query($con,"UPDATE appointment1 set appointid='" . $_POST['appointid'] . "', appoint_date='" . $_POST['appoint_date'] . "', appoint_time='" . $_POST['appoint_time'] . "',c_mail='" . $_POST['c_mail'] . "',c_phoneno='" . $_POST['c_phoneno']. "'  WHERE appointid='" . $_POST['appointid'] . "'");
$message = "Record Modified Successfully";
}

$result = mysqli_query($con, "SELECT * FROM appointment1 where appointid='" . $_GET['id'] . "'");
...
<head>
      ...
      <div style="margin-left: 500px;top:6pc;position: absolute;">
            ...
            <h1 style="color: rgb(79, 4, 44);font-size: 25px;font-family: cursive;margin-left: 40px;"> Update </h1><br>
